...
class TestViews(unittest.TestCase):
    def setUp(self):
        self.app = otterwiki.app.test_client()
    ...
    def test_about(self):
        result = self.app.get('/wiki/about')
    ...
    def test_create(self):
        result = self.app.get('/wiki/create')
        # check header
    ...
    def test_create2(self):
        result = self.app.get('/wiki/create/CreateTest')
        # check header
        self.assertIn('<h1>Create Page</h1>',result.data.decode())
        # check text
        self.assertIn('action="/wiki/create"',result.data.decode())
    ...
    def test_edit(self):
        ...
        result = self.app.get('/TestEdit/edit',follow_redirects=True,)
